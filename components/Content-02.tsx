                            ...
                            <div className=" py-8 lg:py-20 my-10">
                                <div className="mx-auto max-w-md lg:max-w-7xl px-4 md:px-10">
                                    <div className="flex flex-col justify-between md:justify-between md:items-center gap-16 sm:gap-10 md:gap-16 lg:flex-row">
                                        <div className="h-auto overflow-hidden md:w-full md:h-full lg:w-5/12 ">
                                            <Image
                                        ...
                                        <div className="grid grid-cols-1 gap-6 md:grid-rows-3 md:gap-16">
                                            <div className="flex gap-4 items-start">

                                                <div className="px-4 py-[0.4rem] rounded-full bg-purple/20 text-purple text-lg font-rubik">1</div>

                                                <div className="flex flex-col gap-2 text-start max-w-xs font-poppins text-lightBlack ">
                                                    <h5 className="text-xl font-bold tracking-tight">Create a project</h5>
                                                    <p className="">
                                            ...
                                            <div className="flex gap-4 items-start">
                                                ...
                                                <div className="px-4 py-[0.4rem] rounded-full bg-purple/20 text-purple text-lg font-rubik">2</div>

                                                <div className="flex flex-col gap-2 text-start max-w-xs font-poppins text-lightBlack ">
                                                    <h5 className="text-xl font-bold tracking-tight">Assign related people</h5>
                                                    <p className="">
                                                        With lots of unique blocks, you can easily build a
                                                        page without coding.
                                                    </p>
                                            ...
                                            <div className="flex gap-4 items-start">
                                                ...
                                                <div className="px-4 py-[0.4rem] rounded-full bg-purple/20 text-purple text-lg font-rubik">3</div>

                                                <div className="flex flex-col gap-2 text-start max-w-xs font-poppins text-lightBlack ">
                                                    <h5 className="text-xl font-bold tracking-tight">Make it done on-time</h5>
                                                    <p className="">
                                                        With lots of unique blocks, you can easily build a
                                                        page without coding.
                                                    </p>
